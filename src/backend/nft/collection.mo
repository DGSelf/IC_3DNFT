...
shared (_init_msg) actor class Collection(
  _args : {
  ...
  public func init() : async () {
    ...
    //This creates an approval for the owner of the canister and this can be garbage collected if the max_approvals is hit.
    //We advise minting with the target owner in the metadata or creating an assign function (see assign)
    if (_init == false) {
